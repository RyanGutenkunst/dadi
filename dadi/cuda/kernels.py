...
diff_iny_2D = mod.get_function("diff_iny_2D")
drop_last_col_2D = mod.get_function("drop_last_col_2D")

calc_s = mod.get_function('calc_s')
calc_c1 = mod.get_function('calc_c1')
combine_terms = mod.get_function('combine_terms')