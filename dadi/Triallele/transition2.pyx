...
def transition2(np.ndarray[np.float64_t, ndim=1] x,np.ndarray[np.float64_t, ndim=1] dx,np.ndarray[np.float64_t, ndim=2] U01, np.float64_t sig1, np.float64_t sig2, np.float64_t nu):
    cdef int ii
    cdef int jj
